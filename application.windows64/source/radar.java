...
public void drawText() { // draws the texts on the screen
  ...
  textSize(40);
  text("Radar", width-width*0.875f, height-height*0.0277f);
  text("Angulo: " + iAngle +" °", width-width*0.48f, height-height*0.0277f);
  text("Dist:", width-width*0.26f, height-height*0.0277f);
  if(iDistance<40) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "radar" };
    if (passedArgs != null) {
